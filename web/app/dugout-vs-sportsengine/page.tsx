...
export const metadata: Metadata = {
  ...
  description: 'Honest comparison of Pulse FC and SportsEngine for Directors of Coaching and soccer club administrators. AI features, pricing, and multi-team management.',
};
    ...
    <div style={{ minHeight: '100vh', background: '#080808', color: '#f0f0f0', fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", system-ui, sans-serif' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '72px 24px 48px', textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 18, color: '#888', lineHeight: 1.7, maxWidth: 560, margin: '0 auto 48px' }}>
          SportsEngine is built for leagues and state associations. Pulse FC is built for soccer clubs — with AI that handles the admin that eats your evenings.
        </p>
      ...
      <div style={{ borderTop: '1px solid #111', background: '#060606', padding: '64px 24px' }}>
        <div style={{ maxWidth: 800, margin: '0 auto' }}>
          ...
          <p style={{ fontSize: 15, color: '#888', textAlign: 'center', marginBottom: 48, lineHeight: 1.6 }}>
            SportsEngine is built for state associations running hundreds of teams. Pulse FC is built for the club that just needs to run well.
          </p>
