// Run after SETUP_TRYOUTS.sql is applied: node scripts/seed-maroons-form.mjs
// Seeds the Maroons SC tryout form config into tryout_form_config
...
const config = {
  ...
  questions: [
    { id: 'q_tryout_date', type: 'radio', label: 'Which tryout date will you be attending?', helpText: "Select the session that matches your player's grade. See the session schedule above.", required: true, options: ['Saturday, April 11th (Boys & Girls)','Tuesday, April 14th (Girls ONLY)','Wednesday, April 15th (Boys ONLY)'], fieldKey: 'tryout_date', builtIn: false },
    { id: 'q_grade_alignment', type: 'radio', label: 'Is your child in the school grade that aligns with the October 1 school cutoff?', helpText: 'Players born in August or September may be in a different grade than typical for their birthdate.', required: true, options: ['Yes','No — my child is in a higher grade than typical for their birthdate','No — my child is in a lower grade than typical for their birthdate'], fieldKey: 'grade_alignment', builtIn: false },
    { id: 'q_email_secondary', type: 'text', label: 'Additional Parent/Guardian Email (Optional)', helpText: 'If provided, offer letters and important updates will also be sent to this address.', required: false, options: [], fieldKey: 'email_secondary', builtIn: false },
    { id: 'q_prev_experience', type: 'radio', label: 'Previous Soccer Experience', helpText: '', required: true, options: ['Rec','Travel','Club','None'], fieldKey: 'prev_experience', builtIn: false },
    { id: 'q_dual_card', type: 'radio', label: 'Do you plan to dual card and play for another club during the 2026–2027 season?', helpText: '', required: true, options: ['Yes, I plan to dual card and play for another club.','No, Maroons SC will be my primary and only club.','Not sure yet.'], fieldKey: 'dual_card', builtIn: false },
    { id: 'q_dual_card_league', type: 'radio', label: 'If Yes, what league will that club compete in?', helpText: 'Only complete if you answered Yes to the question above.', required: false, options: ['US CLUB (NCSA & NPL)','NJYS (EDP)','Not Sure'], fieldKey: 'dual_card_league', builtIn: false },
    { id: 'q_maroons_status', type: 'radio', label: 'What is your current status with Maroons SC?', helpText: '', required: true, options: ['I am currently rostered on a Maroons SC team','I previously played for Maroons SC but have left and want to return','I have never played for Maroons SC and am a new player'], fieldKey: 'maroons_status', builtIn: false },
    { id: 'q_agreement_1', type: 'checkbox', label: 'By submitting this form, I confirm that the information provided is accurate, and I understand the tryout process and club policies.', helpText: '', required: true, options: [], fieldKey: 'agreement_1', builtIn: false },
    { id: 'q_agreement_2', type: 'checkbox', label: 'By submitting this form, I acknowledge that I will be contacted regarding tryout results and next steps.', helpText: '', required: true, options: [], fieldKey: 'agreement_2', builtIn: false },
  ],
};
